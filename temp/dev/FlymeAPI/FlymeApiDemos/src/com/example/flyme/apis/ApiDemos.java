...
public class ApiDemos extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String path = intent.getStringExtra("com.example.flyme.apis.Path");
        ...
        getListView().setPadding(getListView().getPaddingLeft(), paddingTop, getListView().getPaddingRight(), paddingBottom);
    }
    ...
    protected List<Map<String, Object>> getData(String prefix) {
        ...
        mainIntent.addCategory("android.intent.category.FLYME_SAMPLE_CODE");
    ...
    protected Intent browseIntent(String path) {
        ...
        result.putExtra("com.example.flyme.apis.Path", path);
        return result;
    }
